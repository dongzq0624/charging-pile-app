<template>
	<view class="content-top">
		<swiper @change="swiperChange" :style="{height:height+'rpx;width:100vw;'}" circular="true" autoplay="true"
			interval="6000" :previous-margin="previousMargin" :next-margin="nextMargin">
			<swiper-item v-for="(item,index) in swiperItems" :key="index">
				<view class="content" @click="displayListClick(item)"
